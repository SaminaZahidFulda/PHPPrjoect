          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="tabbable tabs-right">
                ...
                </ul><form action="<?php echo base_url(); ?>Supplier_controller/addsupplier" enctype="multipart/form-data" class="form-horizontal row-border" method="post" />
                ...
                <div class="form-group lable-padd">
                  ...
                  <div class="col-sm-6">
                    <input type="text" placeholder="Enter First Name" required class="form-control"   name="supplier_fname" id="supplier_fname" value="<?php echo set_value('supplier_fname'); ?>" /><?php echo form_error('supplier_fname'); ?>
                  </div>
                </div>
                <div class="form-group lable-padd">
                  <label class="col-sm-3">Supplier Last Name</label>
                  <div class="col-sm-6">
                    <input type="text" placeholder="Enter First Name" required class="form-control" name="supplier_lname" id="supplier_lname" value="<?php echo set_value('supplier_lname'); ?>"/><?php echo form_error('supplier_lname'); ?>
                  </div>
                </div>
                 ...
                 <div class="form-group lable-padd">
                  ...
                  <div class="col-sm-6">
             <input type="text" data-type="email" placeholder="Enter Email address" value="<?php echo set_value('supplier_email'); ?>" required class="form-control"  name="supplier_email" id="supplier_email" /><?php echo form_error('supplier_email'); ?>
                  </div>
                </div>             
                ...
                <div class="form-group lable-padd">
                  ...
                  <div class="col-sm-6">
                    <input type="integer"  data-type="phone" placeholder="XXX XXXXXXX" value="<?php echo set_value('supplier_phone'); ?>" required class="form-control" name="supplier_phone" id="supplier_phone" /><?php echo form_error('supplier_phone'); ?>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <input type="integer"  data-type="phone" placeholder="XXXX-XXXXXXX" value="<?php echo set_value('supplier_mobile'); ?>" required class="form-control" name="supplier_mobile" id="supplier_mobile" /><?php echo form_error('supplier_mobile'); ?>
                  </div>
                       ...
                       <div class="form-group lable-padd">
                          ...
                          <div class="col-sm-6">
                            ...
                            <option value="0">Parent</option>
                                <?php
               $parents= $this->general_model->selectcategory();
...
<div class="form-group lable-padd">
                  <label class="col-sm-3">Sample Image</label>        
            <input type="file" placeholder="Sample Image" title="Sample Image"   id="image" name="image" >
                </div> </div>
               
<div class="form-group lable-padd">
                  <label class="col-sm-3">Category Name</label>
                  <div class="col-sm-6">
                    <input type="text"  placeholder="Enter Category"  required class="form-control" name="category_name" id="category_name"/>
                  </div>
                  ...
                  <div class="col-sm-6">
                    <input type="text"  placeholder="Enter Shop Name" value="<?php echo set_value('supplier_shopname'); ?>" required class="form-control" name="supplier_shopname" id="supplier_shopname"/><?php echo form_error('supplier_shopname'); ?>
                  </div>
                  ...
                  <div class="col-sm-6">
                      <textarea class="form-control" id="supplier_address"  name="supplier_address" rows="2" value="<?php echo set_value('supplier_address'); ?>"  ></textarea><?php echo form_error('supplier_address'); ?>
                  ...
                  <input type="hidden" name="Store_id" id="Store_id" value=" <?php echo $this->session->userdata('store_id'); ?>" />
                    ...
                    <input type="hidden" name="supplier_added" id="supplier_added" value="<?php echo date('Y-m-d H:i:s'); ?> " />
