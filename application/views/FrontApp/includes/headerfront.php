...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <meta name="description" content="Malik Silk Emporium">
        <meta name="author" content="MosaicDesign">
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
        <link rel="stylesheet" type="text/css" href="http://localhost/ProjectMSE/frontend/css/theme-style.css">
        <link rel="stylesheet" href="http://localhost/ProjectMSE/frontend/css/ie.style.css" value="<?php echo base_url(); ?>frontend/css/ie.style.css">
        <!--[if lt IE 9]>
        ...
        <![endif]-->
        <script src="http://localhost/ProjectMSE/frontend/js/vendor/modernizr.js"></script>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="top-welcome hidden-xs hidden-sm">
                                <p>Welcome Malik Silk Emporium &nbsp;&nbsp;<i class="fa fa-phone"></i> 707-505-8008 &nbsp; <i class="fa fa-envelope"></i> support@gmail.com</p> 
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="header-main-block1">
                        <div class="container">
                            <div id="container-fixed">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="index.html" class="header-logo"> <img src="<?php echo base_url(); ?>frontend/img/logo-big-shop.png" alt=""></a>        
                                    </div>
                                    ...
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Home <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                            <ul class="dropdown-menu list-unstyled fadeInUp animated">
                                                ...
                                                <li>
                                                    <a  href="index2.html"> Home Header Light</a>
                                                </li>
                                                <li>
                                        ...
                                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Sub menu <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                            <ul class="dropdown-menu list-unstyled fadeInUp animated">
