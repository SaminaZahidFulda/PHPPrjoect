...
<html lang="en" class="no-js">
 ...
 <div id="navbar-collapse-1" class="navbar-collapse collapse ">
                               ...
                               <li class="dropdown yamm-fw"><a href="<?php echo base_url().'ListProducts_controller/Show/'.$p->category_id; ?>" data-toggle="dropdown" class="dropdown-toggle" ><?php echo $p->category_name;  ?> <i class="fa fa-caret-right fa-rotate-45"></i></a>
			...
			?>
                                                                <ul class="header-menu">
                                                                    <li><a href="<?php echo base_url().'ListProducts_controller/Show/'.$p->category_id; ?>"><?php echo $p->category_name;  ?></a></li>
