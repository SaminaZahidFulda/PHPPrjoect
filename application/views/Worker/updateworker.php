...
require_once('includes/sidebar.php');   
  ...
  <div class="row">
          ...
          <div class="widget">
            ...
            <form action="<?php echo base_url(); ?>Worker_controller/updateWorker/<?php echo $Worker->worker_ID; ?>" method="post" id="form11">
             <div class="col-lg-6">
             <fieldset>
                    ...
                    <div class="col-md-3">
                     ...
                     <input type="text"  class="col-xs-8 form-control" required name="worker_name" id="worker_name" value="<?php echo $Worker->worker_name; ?>">
                      </div>
                   ...
                   <div class="control-group">
                    <div class="col-md-3">
                      ...
                      <input type="text"  name="worker_salary" class="form-control" value="<?php echo $Worker->worker_salary; ?>" id=worker_salary">
                      </div>
                      </div>
                  </div>
                           <br> <br> <br>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="form-group">
                        <input type="text"  name="advance_salary" class="form-control" value="<?php echo $Worker->advance_salary; ?>" id="adance_salary">
                      </div>
                      </div>
                      </div>
                    <br> <br> <br>
                    ...
                    <div class="col-md-3">
                      ...
                      <input type="text"  name="working_hours" value="<?php echo $Worker->working_hours; ?>" class="form-control" id="working_hours">
                      </div>
                      </div>
                    </div>
                     <br> <br> <br>
                  ...
                  <fieldset>
                      ...
                      <div class="form-group">
                        <div class="col-xs-12 col-sm-9">
                          ...
                          <span class="input-group-addon">
                            ...
                            <input type="email" name="worker_email" value="<?php echo $Worker->worker_email; ?>" class="form-control parsley-validated" required data-trigger="change" id="worker_email">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="form-group">
                        <div class="col-xs-12 col-sm-10">
                          <div class="input-group">
                            <input type="text" maxlength="28" name="worker_phone" value="<?php echo $Worker->worker_phone; ?>"required class="form-control  mask parsley-validated" id="worker_phone">
                            <span class="input-group-btn">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="col-md-9">
                          <textarea class="form-control" rows="5" id="worker_address" name ="worker_address"><?php echo $Worker->worker_address; ?></textarea>
                            </div>
                            </div>
                  </fieldset>
            ...
            <div class="form-actions">                  
                    <button class="btn btn-primary" type="submit" id="Add">Update Worker</button>
                    </div> 
              </form>
