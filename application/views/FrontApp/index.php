                    ...
                    <ul class="list-unstyled">	<!-- SLIDE  -->
                       <?php foreach($pics as $p){ ?>
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                            <!-- MAIN IMAGE -->
                            <img src="<?php echo base_url(); ?>uploads/bannerPics/<?php echo $p->banner_image; ?>"   alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                            <!-- LAYERS -->
                            <div class="tp-caption skewfromrightshort customout"
                                 ...
                                 style="z-index: 4">
                                <img src="<?php echo base_url(); ?>frontend/img/preview/slider/1.png" alt="">
                            </div>
                            <div class="tp-caption skewfromrightshort customout"
                                 data-x="20"
                                 data-y="224"
                                 ...
                                 data-captionhidden="on"
                                 style="z-index: 4">
                                <img src="<?php echo base_url(); ?>frontend/img/preview/slider/1-2.png" alt="">
                            </div>
                            <div class="tp-caption skewfromrightshort customout"
                                 data-x="20"
                                 data-y="335"
                                 ...
                                 data-captionhidden="on"
                                 style="z-index: 4">
                                <img src="<?php echo base_url(); ?>frontend/img/preview/slider/1-1.png" alt="">
                            </div>
  ...
  <section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <article class="home-category-block">
                                <div class="home-category-title">
                                    <i class="fa fa-male"></i> <a href="">Bridal Collection</a> 
                                </div>
                                <div class="home-category-option">
                                    <ul class="list-unstyled home-category-list">
                                        <li><a href=""><i class="fa fa-check"></i>Lehnga Dress</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Mehndi Dresses</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Churi Pajama</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Sharara Style</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Maxy Goan/a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Open Shirt Style</a></li>
                                    </ul>
                                    <img src="<?php echo base_url(); ?>uploads/bannerPics/1936314_916055855175246_7006325570828397388_n.jpg" class="img-responsive" alt="">
                                </div>
                            </article>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <article class="home-category-block">
                                <div class="home-category-title">
                                    <i class="fa fa-female"></i> <a href="">Party Wear</a>
                                </div>
                                <div class="home-category-option">
                                    <ul class="list-unstyled home-category-list">
                                        <li><a href=""><i class="fa fa-check"></i>Fancy Emporium</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Embrioded Suit</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Trendz Froks</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>ZebTan Style</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Simple Goan</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Jump Pajama Style</a></li>
                                    </ul>
                                    <img src="<?php echo base_url(); ?>uploads/bannerPics/1620870_933204276793737_6004429965826916323_n1.jpg" class="img-responsive" alt="">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <article class="home-category-block">
                                <div class="home-category-title">
                                    <i class="fa fa-child"></i> <a href="">Wedding Special</a>
                                </div>
                                <div class="home-category-option">
                                    <ul class="list-unstyled home-category-list">
                                        <li><a href=""><i class="fa fa-check"></i><b style=" color : tomato">Lehnga Sets</b></a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Short Shirt Style</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Karigari</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Embrioded Variety</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Churi Pajama</a></li>
                                        <li><a href=""><i class="fa fa-check"></i>Meenakari Design</a></li>
                                    </ul>
                                    <img src="<?php echo base_url(); ?>uploads/bannerPics/13082602_964033103710854_7157630279603896935_n.jpg" class="img-responsive" alt="">
                                </div>
                            </article>  
                        </div>
                    </div>
        ...
        <section>
            <div class="color-scheme-2">
                <div class="container">
                    <div class="row">
                        <?php foreach($picsub as $p){ ?>
                        
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <article class="banner">
                                <a href="#">
                                    <img src="<?php echo base_url(); ?>uploads/bannerPics/<?php echo $p->banner_image; ?>" class="img-responsive" alt="">
                                </a> 
                            </article>
                        </div>
                        <?php }?>
